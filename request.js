...
const currentWeather = 'https://api.openweathermap.org/data/2.5/weather?q=London&appid=762aa9c00ad9320d5e74709fb42178de';

fetch(currentWeather)
    .then((weatherData) => {
        console.log('response', weatherData.json())
    })
    .catch((error)=>{
        console.log(error)
    });
